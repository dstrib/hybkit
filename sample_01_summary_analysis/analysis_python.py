...
out_dir = os.path.join(analysis_dir, 'output_py')
input_files = [
...
# Initialize a list of Analysis Dict objects
analysis_dicts = []
...
for in_file_path in input_files:
    ...
    out_file_name = in_file_name.replace('.hyb', '_analyzed_qc.hyb')
